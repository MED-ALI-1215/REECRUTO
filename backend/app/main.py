...
from app.api.routes import admin, auth, candidates, dashboard, interviews, jobs
...
async def app_error_handler(request: Request, exc: AppError) -> JSONResponse:
    logger.warning(
        "AppError %s on %s %s: %s", type(exc).__name__, request.method, request.url.path, exc.detail
    )
